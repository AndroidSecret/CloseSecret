...
public abstract class AbstractMyActivityGroup extends ActivityGroup implements
    ...
    /**
     * 加载Activity的View容器的id并不是固定的，将命名规则交给开发者  * 开发者可以在布局文件中自定义其id，通过重写这个方法获得这个View容器的对象  * @return
     */
    abstract protected ViewGroup getContainer();

    /**
     * 供实现类调用，根据导航按钮id初始化按钮  * @param id
     */
    ...
    /**
     * 为启动Activity初始化Intent信息  * @param cls  * @return
     */
