...
public class Timeline extends HttpServlet{	//返回所有的消息列表，包括朋友的和自己的
...
//    	//向客户端返回json数据
        ...
        if ( !(str.equals(phone_md5)) && !(str.equals(token)) ){  
        	List<Message> timeline = msgService.getTimeline(phone_md5);
        	...
        	if(timeline.size() > 0){
        		...
        		for(int i = 0 ;i < timeline.size(); i ++){
        			...
        			array.add(jsonItem);
        			System.out.println("timeline:"+jsonItem.toString());
        		}
